  ...
  return (
    <div className="min-h-screen bg-gradient-to-bl from-black via-red-950 to-black relative overflow-hidden">
      ...
      <div className="relative z-10 py-20 px-6">
       ...
       <div
  key={platform.id}
  className="group relative bg-gradient-to-br from-white/8 via-white/4 to-transparent backdrop-blur-2xl border border-white/10 rounded-3xl p-6 cursor-default transition-all duration-500 hover:scale-105 hover:bg-gradient-to-br hover:from-white/12 hover:via-white/6 hover:to-white/3 hover:border-white/20 hover:shadow-2xl hover:shadow-black/40"
  style={{
...
>
  ...
  <div className="flex justify-between items-start mb-6">
    <div
      className="w-14 h-14 rounded-2xl flex items-center justify-center backdrop-blur-sm border border-white/10 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 relative overflow-hidden"
      style={{
    ...
    >
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(135deg, ${platform.color}30, transparent)`,
        }}
      ></div>
      <Icon
        size={20}
    ...
    <div className="flex gap-2">
      <button
        ...
        className="w-8 h-8 rounded-full bg-white/8 backdrop-blur-sm border border-white/10 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white/15 hover:scale-110 cursor-pointer"
      >
  ...
  {/* Platform Info */}
  <div className="mb-6">
    <h3 className="text-xl font-bold text-white mb-2 group-hover:text-gray-100 transition-colors duration-300 tracking-tight">
      {platform.name}
    </h3>
    <div
      className="inline-block px-2 py-1 rounded-full text-xs font-bold tracking-wider uppercase mb-3 border"
      style={{
  ...
  <button
    type="button"
    onClick={() => handleButtonClick(platform.url, platform.name)}
    className="w-full py-3 px-6 rounded-3xl font-bold text-sm transition-all duration-300 backdrop-blur-sm border border-white/10 relative overflow-hidden cursor-pointer focus:outline-none focus:ring-2 focus:ring-white/20"
    style={{
  ...
  {/* Glow effects */}
  <div
    className="pointer-events-none absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-10 transition-opacity duration-500 blur-2xl -z-10"
    style={{ backgroundColor: platform.color }}
  ></div>
  <div
    className="pointer-events-none absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 border"
    style={{
